...
if __name__ == "__main__":
    ...
    # Parameters
    parser.add_argument("--min_length_days", type=int, default=1, help="Minimum length of a valid ICU stay in days")
    parser.add_argument("--max_length_days", type=int, default=60, help="Maximum length of a valid ICU stay in days")
    parser.add_argument("--max_hr_disconnect_mins", type=int, default=120, help="Maximum time in minutes that HR channel could be disconnected")
